...
Asura:
{
    While, GetKeyState(DDLAsura, "P")
    {
        ...
        If (Memory("Status"))
        {
            Send, {%DDLMace%}        ; Enviar el valor de DDLMace
            Send, {%DDLAsura%}       ; Enviar el valor de DDLAsura
            MouseClick, Left          ; Realizar clic izquierdo
        }
        Else
        {
            Send, {%DDLGlorious%}    ; Enviar el valor de DDLGlorious
            Send, {%DDLCritical%}    ; Enviar el valor de DDLCritical
        }
