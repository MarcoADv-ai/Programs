...
Gui, Add, GroupBox, xm ym w220 h60, Seleccionar ventana
Gui, Add, DDL, xp+10 yp+20 r5 w200 vDDLClient gDDLClient_Select, 
ClientList()

; Agregar botones
Gui, Add, Button, xm+20 yp+70 w80 h30 gButtonCerrar, Cerrar ; Solo el botón de Cerrar

Gui, Show, w240 h120, Selección de ventana
Return
