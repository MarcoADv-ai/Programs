...
Gui, Add, GroupBox, x12 y10 w210 h10, Seleccionar Cliente
Gui, Add, Text, x22 y30 w50 h20 +Right, WinID:
Gui, Add, Edit, vWID1 x82 y30 w60 h20 +ReadOnly,
Gui, Add, Button, gSet1 x152 y30 w40 h20, Set
Gui, Font, s8, Segoe UI
Gui, Add, GroupBox, xm ym+70 w180 h53, Client
Gui, Add, DDL, xp+15 yp+20 r2 w150 vDDLClient +AltSubmit,
ClientList()
WM_COMMAND := 0x0111, OnMessage(WM_COMMAND, "On_CBN_DROPDOWN")
Gui, Add, GroupBox, xm ym+135 w180 h125, Skills
Gui, Add, Picture, xp+50 yp+20 AltSubmit, %Dir%\hocus.gif
...
Gui, Add, Picture, xp-30 yp+30 AltSubmit, %Dir%\cancel.gif
...
Gui, Add, Button, xm+5 ym+305 w170 h30 vButtonInject, Inject
Gui, Add, Button, xm+5 ym+340 w170 h30 vButtonStart, Start
...
ControlSend,, {%DDLHocus%}, ahk_id %WID1%
Sleep(140)
BaseAddress := getProcessBaseAddress(ahk_pid %PID%)
offset1 := 0x00A43F44
offset2 := 0x450
pointerAddress := BaseAddress + offset1
pointerValue := ReadMemory(pointerAddress, PID)
finalAddress := pointerValue + offset2
skill_id := ReadMemory(finalAddress, PID)
if (skill_id = 292)
{
SoundPlay, %Dir%\tadad.wav
