            ...
            if text:
                ...
                try:
                    ...
                    if numeric_text:
                        ...
                        time.sleep(2)  # Esperar 3 segundos antes de escribir
                        ...
                        return  # Volver a la validación inicial
...
def main():
    ...
    while not glfw.window_should_close(window):
        frame_start_time = time.time()  # Marca de tiempo al inicio del frame
        ...
        if imgui.begin("Auto Captcha"):
            ...
            if imgui.button("Start CAPTCHA Bypass for Honey RO"):
                ...
                while search_area_for_text("Hello, illegal software", area_coords):
