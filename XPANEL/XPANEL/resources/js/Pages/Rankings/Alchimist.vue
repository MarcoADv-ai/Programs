...
<template>
    <ranking-panel title="Deaths Counter">
        <ranking-table :rank_attributes="rank_attributes">
            <template #row>
                <tr class="spaceUnder hover:bg-gray-300/40 dark:hover:bg-white/20" v-for="(alchimist, index) in alchimists.data" :key="index">
                    ...
                    <td class="px-5 py-3">
                        <div class="flex items-center justify-center">
                            <img :src="`/rochar/character-head/${alchimist.name}`" alt="" />
                            <a href="">
