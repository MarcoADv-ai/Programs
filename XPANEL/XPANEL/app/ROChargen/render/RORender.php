<?php
namespace App\ROChargen\render;

use App\ROChargen\core\Client;
use App\ROChargen\loaders\Action;
use App\ROChargen\loaders\Sprite;
use CharacterRender;
use DB;
...
abstract class RORender
{
	 ...
	 */
	public $image_size              = array(200,130);
	public $dot_reference           = array(100,90);
